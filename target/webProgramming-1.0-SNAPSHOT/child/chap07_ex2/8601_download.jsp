    ...
    <div class="row display-flex contain-inputPage">
        ...
        <div class="list-container">
            <div class="list-row list-title">
                <div>
                    <h1>Downloads</h1>
                    <h2 class="band-name">${product.description}</h2>
                </div>
            </div>
            <div class="list-row list-items">
                <div class="contain-song col-2 aos-init aos-animate">
                    <div class="cart-custom">
                        <div class="cart-custom-content">
                            <h5>You Are a Star</h5>
                            <a href="/musicStore/sound/${product.code}/star.mp3" class="cta">
                                <span class="enjoy-span">ENJOY IT</span>
                                <span class="second">
                ...
                <div class="contain-song col-2 aos-init aos-animate">
                    <div class="cart-custom">
                        <div class="cart-custom-content">
                            <h5>Don't Make No Difference</h5>
                            <a href="/musicStore/sound/${product.code}/no_difference.mp3" class="cta">
                                <span class="enjoy-span">ENJOY IT</span>
                                <span class="second">
                                    <svg width="50px" height="20px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <br>
            <p><a class="view-cookie" href="?action=viewCookies">View all cookies</a></p>
            <form action="?action=viewAlbums" method="post">
                <input type="hidden" name="action" value="join">
                <button class="return-btn" type="submit">Return List Of Albums
                </button>
            </form>
        </div>
    </div>
